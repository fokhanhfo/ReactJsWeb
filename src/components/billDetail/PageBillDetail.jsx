...
function PageBillDetail() {
  ...
  const steps = ['Đã đặt hàng', 'Chờ phê duyệt', 'Chuẩn bị hàng', 'Vận chuyển', 'Chờ giao hàng', 'Hoàn thành'];
  ...
  return (
    <Box display="flex" flexDirection="column" gap={2}>
      ...
      >
        <Button startIcon={<ArrowBackIcon />} sx={{ color: '#777' }} variant="text">
          TRỞ LẠI
        </Button>
              ...
              <Box>
                <Grid container>
                  ...
                  <Grid item xs={6} sx={{ textAlign: 'right' }}>
                    <Typography>{billData.billDetail.reduce((sum, item) => sum + item.quantity, 0)}</Typography>
                  </Grid>
                </Grid>
              </Box>
              <Box>
                <Grid container>
                  ...
                  <Grid item xs={6} sx={{ textAlign: 'right' }}>
                    <Typography>{formatPrice(billData.total_price)}</Typography>
                  </Grid>
                </Grid>
              </Box>
              <Box>
          ...
          <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
            ...
            >
              ...
              <Stack direction="row" alignItems="center" spacing={2} sx={{ mt: 2 }}>
                ...
                <Box>
                  <Typography sx={{ fontWeight: 'bold' }}>Gabrielle Feyer</Typography>
                  <Typography variant="body2" color="text.secondary">
                    Customer ID: #47389
                  </Typography>
                </Box>
              </Stack>
              <Typography sx={{ mt: 2, fontWeight: 'bold', color: '#1976d2' }}>12 Orders</Typography>
              <Divider sx={{ my: 2 }} />
              <Box>
